package ru.baddecision.blog.integration.web.controller;
...
import ru.baddecision.blog.web.controller.PostController;
...
class PostControllerIT extends IntegrationTestBase {
    ...
    void createPost_successRedirect() throws Exception {
        MockMultipartFile file = new MockMultipartFile("file", "filename.png", "text/plain", "some file".getBytes());
